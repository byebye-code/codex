...
impl ChatComposer {
    ...
    pub fn desired_height(&self, width: u16) -> u16 {
        ...
        let footer_total_height = match &self.active_popup {
            ...
            ActivePopup::Skill(s) => s.calculate_required_height(width).max(1),
        };
    ...
    fn render_layout(&self, area: Rect) -> ComposerRenderLayout {
        ...
        let footer_reserved_height = match &self.active_popup {
            ...
            ActivePopup::Skill(popup) => popup.calculate_required_height(area.width).max(1),
            ActivePopup::None => {
...
impl WidgetRef for ChatComposer {
    fn render_ref(&self, area: Rect, buf: &mut Buffer) {
        ...
        let popup_rect = layout.footer_area;
